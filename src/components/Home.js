						...
						<div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
							<div className="p-2 sm:w-1/2 w-full">
								<div className="bg-gray-100 rounded flex p-4 h-full items-center">
									...
									<span className="title-font font-medium text-left" >Store images in AWS cloud</span>
								</div>
							</div>
							<div className="p-2 sm:w-1/2 w-full">
								<div className="bg-gray-100 rounded flex p-4 h-full items-center">
									...
									<span className="title-font font-medium text-left">Use of AWS Rekognition</span>
							...
							<div className="p-2 sm:w-1/2 w-full">
								<div className="bg-gray-100 rounded flex p-4 h-full items-center">
									...
									<span className="title-font font-medium text-left">Tag photos</span>
								</div>
							</div>
							<div className="p-2 sm:w-1/2 w-full">
								<div className="bg-gray-100 rounded flex p-4 h-full items-center">
									...
									<span className="title-font font-medium text-left">Responsive design</span>
								</div>
							</div>
							<div className="p-2 sm:w-1/2 w-full">
								<div className="bg-gray-100 rounded flex p-4 h-full items-center">
									...
									<span className="title-font font-medium text-left ">Create directories <span className="text-indigo-400"> [upcoming] </span> </span>
								</div>
							</div>
							<div className="p-2 sm:w-1/2 w-full">
								<div className="bg-gray-100 rounded flex p-4 h-full items-center">
									...
									<span className="title-font font-medium text-left">Share photos <span className="text-indigo-400">[upcoming]</span></span>
								</div>
							</div>
						</div>
